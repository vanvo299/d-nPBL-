/*
DỰ ÁN PBL 1: LẬP TRÌNH TÍNH TOÁN
Chủ đề 703: Dự án xây dựng chương trình quản lý sinh viên
*/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
int main()
{
    ...
    int n;
    // FILE *quanLySinhVien;
    // quanLySinhVien = fopen("danhSachSinhVien.txt", "w");
    while (1) {
